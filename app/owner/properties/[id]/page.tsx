    ...
    <OwnerLayout>
      <div className="space-y-6">
        ...
        <Link href="/owner/properties">
          <a className="inline-flex items-center gap-2 text-[#59A5B2] hover:text-[#4a9199] transition-colors">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
          ...
          <div className="relative">
            ...
            <div className="relative h-[300px] md:h-[400px] bg-gray-200 dark:bg-gray-700 rounded-xl overflow-hidden mb-4">
              ...
              <button
                onClick={prevImage}
                className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 dark:bg-gray-800/80 rounded-full flex items-center justify-center shadow-md hover:bg-white dark:hover:bg-gray-800 transition-colors"
              >
                <FontAwesomeIcon icon={faChevronLeft} className="w-4 h-4 text-gray-800 dark:text-white" />
              </button>
              <button
                onClick={nextImage}
                className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 dark:bg-gray-800/80 rounded-full flex items-center justify-center shadow-md hover:bg-white dark:hover:bg-gray-800 transition-colors"
              >
